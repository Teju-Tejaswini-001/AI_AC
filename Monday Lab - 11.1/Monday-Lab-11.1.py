...
'''#TASK3 
# Use AI to generate a Singly Linked List with insert and displaymethods.Sample Input Code:class Node:passclass LinkedList:passExpected Output:• A working linked list implementation with clear methoddocumentation.Task Description #4 – Binary Search Tree (BST)
class Node:
...
'''# Task-4
#Binary Search Tree (BST)Task: Use AI to create a BST with insert and in-order traversal methods.Sample Input Code:class BSTpassExpected Output:• BST implementation with recursive insert and traversal methods.
class Node:
...
'''# Task-5
# Use AI to implement a hash table with basic insert, search, and delete methods.Input Code:class HashTable:passExpected Output:• Collision handling using chaining, with well-commented methods.
class HashTable:
    def __init__(self):
    ...
    def delete(self, key):
        """Delete a key-value pair from the hash table. Returns True if deleted, else False."""
        index = self._hash(key)
        bucket = self.table[index]
...
if __name__ == "__main__":
    ...
    print("Delete 'age':", hash_table.delete("age"))
    print("Search for 'age' after deletion:", hash_table.search("age"))
'''

'''# Task-6
# Use AI to implement a graph using an adjacency list.Sample Input Code:class Graph:passExpected Output:•Graph with methods to add vertices, add edges, and display connections.
class Graph:
    def __init__(self):
